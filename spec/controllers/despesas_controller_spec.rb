...
describe DespesasController do
  ...
  let(:valid_attributes) { { "nomedespesa" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved despesa as @despesa" do
        ...
        post :create, {:despesa => { "nomedespesa" => "invalid value" }}, valid_session
        assigns(:despesa).should be_a_new(Despesa)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested despesa" do
        ...
        Despesa.any_instance.should_receive(:update).with({ "nomedespesa" => "MyString" })
        put :update, {:id => despesa.to_param, :despesa => { "nomedespesa" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the despesa as @despesa" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Despesa.any_instance.stub(:save).and_return(false)
        put :update, {:id => despesa.to_param, :despesa => { "nomedespesa" => "invalid value" }}, valid_session
        assigns(:despesa).should eq(despesa)
      end
